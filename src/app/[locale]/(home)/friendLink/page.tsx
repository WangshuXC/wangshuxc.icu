      ...
      <div className="mx-auto max-w-6xl">
            ...
            >
              <CardHeader className="relative pb-2">
                <CardTitle className="flex items-start justify-between gap-2">
                  ...
                  <ExternalLinkIcon className="mt-1 h-4 w-4 text-muted-foreground/60 transition-colors group-hover:text-primary flex-shrink-0" />
                </CardTitle>
              ...
              <CardContent className="relative pt-0">
                <div className="flex items-center justify-between">
                  <Link
                    ...
                    className="inline-flex items-center gap-2 rounded-full bg-primary/90 px-4 py-2 font-medium text-primary-foreground text-xs transition-all hover:bg-primary hover:shadow-md hover:scale-105"
                  >
                    访问
        ...
        {friendLinkConfig.items.length === 0 && (
          <div className="py-20 text-center">
            ...
            <p className="text-muted-foreground">还没有添加任何友链，敬请期待！</p>
          </div>
        )}
      </div>
    </div>
