...
1. **Create a GitHub OAuth App:**
   ...
   - Set Authorization callback URL to: `http://localhost:3050/api/auth/callback/github`
...
1. **Create a Google OAuth App:**
   ...
   - Set redirect URI to: `http://localhost:3050/api/auth/callback/google`
...
Visit `http://localhost:3050/login` to test:
...
Access the dashboard at `http://localhost:3050/dashboard`:
...
Test the payment flow at `http://localhost:3050/pricing`:
...
Try file operations at `http://localhost:3050/dashboard/files`:
